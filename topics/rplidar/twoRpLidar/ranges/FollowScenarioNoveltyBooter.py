...
''''''
pklFile = open("{}projs/research/data/self-aware-drones/ctumrs/two-drones/follow-scenario/lidars/ranges/".format(MachineSettings.MAIN_PATH)+"twoLidarsTimeRangesVelsObss.pkl", "rb")
